...
## [0.1.0](https://github.com/MKartaviciute/deepagents/compare/deepagents-cli==0.2.2...deepagents-cli==0.1.0) (2026-06-18)
...
* **cli:** add `--host` option to `deepagents dev` command ([#3444](https://github.com/MKartaviciute/deepagents/issues/3444)) ([0bb1e74](https://github.com/MKartaviciute/deepagents/commit/0bb1e74bba8097b38f204e3db6e6ebad7e0f5317))
* **cli:** add docs link to project MCP approval prompt ([#3341](https://github.com/MKartaviciute/deepagents/issues/3341)) ([b5c1228](https://github.com/MKartaviciute/deepagents/commit/b5c12280e47bc37938290a4219317f47c1abfa8a))
* **cli:** add terminal OSC 9;4 progress & escape helper ([#3347](https://github.com/MKartaviciute/deepagents/issues/3347)) ([75d60cd](https://github.com/MKartaviciute/deepagents/commit/75d60cd82f559b2944b78a348d16b0a10a00d663))
* **cli:** filter threads in switcher by directory ([#3290](https://github.com/MKartaviciute/deepagents/issues/3290)) ([07a973a](https://github.com/MKartaviciute/deepagents/commit/07a973ae5b0256fddfd9591dc88c7987e5581264))
* **cli:** free-text reject reason on HITL approval prompt ([#3344](https://github.com/MKartaviciute/deepagents/issues/3344)) ([dcc48f4](https://github.com/MKartaviciute/deepagents/commit/dcc48f48d20757f17011e65b61363dd0347af164))
* **cli:** migrate deepagents deploy to use managed deep agents api [AB-2470] ([#3609](https://github.com/MKartaviciute/deepagents/issues/3609)) ([72aef52](https://github.com/MKartaviciute/deepagents/commit/72aef52542a3fd4a7eebcb3dba40e28adf1aa044))
* **cli:** remove coding agent ([#3422](https://github.com/MKartaviciute/deepagents/issues/3422)) ([c7b3119](https://github.com/MKartaviciute/deepagents/commit/c7b311933da6245267f4bded050c36279973de1e))
* **cli:** show sandbox provider in header `sub_title` ([#3295](https://github.com/MKartaviciute/deepagents/issues/3295)) ([779f7f4](https://github.com/MKartaviciute/deepagents/commit/779f7f45c501f3c6d53e12087e3d4c340ef8aded))
* **cli:** surface sandbox startup errors in server crash messages ([#3306](https://github.com/MKartaviciute/deepagents/issues/3306)) ([2606d57](https://github.com/MKartaviciute/deepagents/commit/2606d57b623f16955df6f91e693051f4b61f6120))
...
* **ci,deps:** harden manual releases and update `python-multipart` ([#3383](https://github.com/MKartaviciute/deepagents/issues/3383)) ([a5da793](https://github.com/MKartaviciute/deepagents/commit/a5da793a78fcd8e9dc47a6cc1f5d62b9eb049543))
* **cli:** add `together` provider to bundler deps and optional extras ([#2670](https://github.com/MKartaviciute/deepagents/issues/2670)) ([4290953](https://github.com/MKartaviciute/deepagents/commit/4290953e44570ec02399e4d423ab4ffd24e97609))
* **cli:** allow TUI launch without preconfigured model credentials ([#3301](https://github.com/MKartaviciute/deepagents/issues/3301)) ([aa28ff7](https://github.com/MKartaviciute/deepagents/commit/aa28ff73768a826b216bfa54d76ecd313c325077))
* **cli:** dedupe MCP servers in project trust approval prompt ([#3342](https://github.com/MKartaviciute/deepagents/issues/3342)) ([73484ea](https://github.com/MKartaviciute/deepagents/commit/73484ea551189985190f52cb26b299819d3fc37d))
* **cli:** expand `${VAR}` in `mcp.json` header values ([#3523](https://github.com/MKartaviciute/deepagents/issues/3523)) ([6cfc5f9](https://github.com/MKartaviciute/deepagents/commit/6cfc5f9004271c23c486a0b05e8f9f0002e75e2b))
* **cli:** keep Thinking spinner during `edit_file` approval ([#3310](https://github.com/MKartaviciute/deepagents/issues/3310)) ([d06133f](https://github.com/MKartaviciute/deepagents/commit/d06133f8dd7cb924c82e46ece3e165d561ef7d9e))
* **cli:** prevent import deadlock during skill discovery and prewarm ([#3385](https://github.com/MKartaviciute/deepagents/issues/3385)) ([0bf8dd1](https://github.com/MKartaviciute/deepagents/commit/0bf8dd1cfd680bd4d27ce19295f96c720f525787))
* **cli:** remove legacy shell tool aliases and harden HITL widget cleanup ([#3340](https://github.com/MKartaviciute/deepagents/issues/3340)) ([398f7f4](https://github.com/MKartaviciute/deepagents/commit/398f7f4512182a8e51cbdfbfb9dc211c77014e2b))
* **cli:** support `state` deploy backend ([#3790](https://github.com/MKartaviciute/deepagents/issues/3790)) ([04b4bb9](https://github.com/MKartaviciute/deepagents/commit/04b4bb946fc5ff914b8cccc8c9543d10533de0f8))
* **cli:** suppress LangSmith trace for `_context_tokens` state writes ([#3317](https://github.com/MKartaviciute/deepagents/issues/3317)) ([63db13e](https://github.com/MKartaviciute/deepagents/commit/63db13ee262d19a1a87fbe4df1271a2e958deed6))
* **cli:** suppress token placeholder on first invoke ([#3302](https://github.com/MKartaviciute/deepagents/issues/3302)) ([c21dee2](https://github.com/MKartaviciute/deepagents/commit/c21dee2e9bc1a7d3f52ff62e9e66d1caaaf7b464))
* **cli:** sync thread ID and render clickable link on `/clear` ([#3305](https://github.com/MKartaviciute/deepagents/issues/3305)) ([0904974](https://github.com/MKartaviciute/deepagents/commit/0904974d52dff259809d00a7a8b26c3e894cc0c0))
* **cli:** truncate multi-line shell commands in HITL approval ([#3314](https://github.com/MKartaviciute/deepagents/issues/3314)) ([7ab6e14](https://github.com/MKartaviciute/deepagents/commit/7ab6e14565d6dd9d9c9e76d9d6677e5568a727f7))
...
* **cli:** gate dropped-path detection on multi-character insert size ([#3343](https://github.com/MKartaviciute/deepagents/issues/3343)) ([06a21e8](https://github.com/MKartaviciute/deepagents/commit/06a21e8a69738b7ba055d2f13dae4cd9fab353cd))
